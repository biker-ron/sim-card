...
class ISO7816(object):
    ...
    def VERIFY(self, P2=0x00, Data=[]):
        ...
        '''
        if len(Data) == 0: 
            VERIFY = [self.CLA, 0x20, 0x00, P2, 0x00]
        # elif len(Data) == 4:  THIS TURNED OUT TO NOT BE NECESSARY BUT HERE FOR INFORMATION ONLY
        #     VERIFY = [self.CLA, 0x20, 0x00, P2, 0x8] + Data + [0xFF, 0xFF, 0xFF, 0xFF]
        elif 1 <= len(Data) <= 255:
...
class UICC(ISO7816):
    ...
    AID_country_code = {
        ...
        (255, 71): 'United States', #not sure about this
        (0xFF, 0x33): 'France',
    ...
    def interpret_AID(aid=[]):
        ...
        print "aid_rid: ", aid_rid
        print "aid_app: ", aid_app
        print "aid_country: ", aid_country
        print "aid_provider: ", aid_provider
        print "rest of aid: ", tuple(aid[11:])
